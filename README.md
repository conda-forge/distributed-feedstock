...
pixi add distributed
# for installing globally
pixi global install distributed
```
...
It is possible to list all of the versions of `distributed` available on your platform:
...
```
pixi search distributed --channel conda-forge
```
